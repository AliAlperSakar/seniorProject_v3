            ...
            <div style={{ marginTop: "100px", marginRight: "50px", marginLeft: "50px", backgroundColor: "white", padding: "5%", borderRadius: "1%" }}>
                ...
                {this.state.add ? <Form>
                    <Form.Group widths='equal'>
                        <Form.Input fluid label='Name' placeholder='Enter tournament name' onChange={this.handleChange} />
                        <DateInput
                            label="Start Date"
                            name="startdate"
                            placeholder="Date"
                            ...
                            <Form>
                                <Form.Group widths='equal'>
                                    ...
                                    <DateInput
                                        ...
                                        onChange={this.handleChange}
                                    />
                                     <Form.Input fluid label='Quota' placeholder='Enter tournament quota' onChange={this.handleChange} />
                                     <Form.Select fluid label ='Campus' placeholder='Choose a campus' onChange={this.handleChange}
                                     options={campusoptions}/>
                                </Form.Group>
                                <Form.Group>
                                    <div style={{ float: "left", marginTop: "20px" }}>
                                        <span>Tournament Photo</span>
                                        <FileUpload />
                                    </div>
                                    <div style={{ float: "right", width: "100%", marginLeft: "50px" }}>
                                        <Form.TextArea style={{ height: "400px" }} label='Content' placeholder='Tournament Content' />
